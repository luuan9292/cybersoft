...
var DanhSachPhimRoutingModule = /** @class */ (function () {
    function DanhSachPhimRoutingModule() {
    }
    ...
    return DanhSachPhimRoutingModule;
}());
...
var DanhSachPhimComponent = /** @class */ (function () {
    //tao bien pham vi la private, giong new tao ra doi tuong kieu nhu nay let http = new HttpClient()
    function DanhSachPhimComponent(movieService) {
        this.movieService = movieService;
    }
    DanhSachPhimComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.movieService.movie().subscribe(function (res) {
            _this.movies = res;
        }, function (err) {
            console.log(err);
        });
    };
    DanhSachPhimComponent.prototype._setDefaultImg = function (image) {
        image.src = "https://er006ogq00-flywheel.netdna-ssl.com/wp-content/uploads/2018/02/default-image-800x600.jpg";
    };
    DanhSachPhimComponent.ctorParameters = function () { return [
...
var DanhSachPhimModule = /** @class */ (function () {
    function DanhSachPhimModule() {
    }
...
//# sourceMappingURL=danh-sach-phim-danh-sach-phim-module-es5.js.map